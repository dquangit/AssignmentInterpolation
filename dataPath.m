...
rainPath = 'data/realdata/rain.txt';

dateInterpolationPath = 'data/interpolationdata/date.txt';
aqiInterpolationPath = 'data/interpolationdata/aqi.txt';
tempInterpolationPath = 'data/interpolationdata/temp.txt';
...
aqiForecastPath = 'data/forecastdata/aqi.txt';
